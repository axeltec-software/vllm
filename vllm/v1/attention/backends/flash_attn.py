...
class FlashAttentionImpl(AttentionImpl):
    ...
    def forward(
        ...
        # This is detected by: empty block_table AND fresh K,V tensors AND pure prefill
        is_prefill_only = (
        ...
        if is_prefill_only:
            # Use direct Q, K, V attention without KV cache (similar to encoder attention)
            ...
            flash_attn_varlen_func(
                ...
                cu_seqlens_k=cu_seqlens_q,  # Same as Q for self-attention
                max_seqlen_q=max_seqlen_q,
                max_seqlen_k=max_seqlen_q,  # Same as Q for self-attention
