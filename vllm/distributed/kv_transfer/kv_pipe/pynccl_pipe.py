...
class PyNcclPipe(KVPipeBase):
    ...
    def _send_tensor_metadata(
            self,
            tensor: torch.Tensor,
            extra_metadata: Optional[Metadata] = None) -> None:
    ...
    def _send_tensor_only(self, tensor: Optional[torch.Tensor],
    ...
    def send_tensor_with_response(
        ...
        self.transport_thread.submit(self._send_tensor_only, tensor,
                                     tensor_size)
