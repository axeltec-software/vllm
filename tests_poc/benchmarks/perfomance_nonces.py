...
def _warmup(
    ...
    body = {
        ...
        "params": {"model": model, "seq_len": seq_len, "k_dim": DEFAULT_K_DIM},
...
def main():
    parser = argparse.ArgumentParser(description="Benchmark vLLM PoC nonces/s")
    ...
    parser.add_argument(
        ...
        default=[32, 64],
        metavar="N",
        help="Space-separated list of n_nonces values to sweep (default: 32 64)",
    )
    parser.add_argument(
        "--max-tokens",
        type=int,
        ...
        metavar="T",
        help="Space-separated list of max_tokens values to sweep (default: 0 32 64 128 256)",
    )
    ...
    if args.url:
        ...
        from tests_poc.server import PoCTestServer
